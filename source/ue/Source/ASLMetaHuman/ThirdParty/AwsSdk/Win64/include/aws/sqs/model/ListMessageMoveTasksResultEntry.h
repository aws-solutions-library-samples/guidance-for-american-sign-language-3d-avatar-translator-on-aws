...
namespace Model
{
  ...
  public:
    ...
    AWS_SQS_API ListMessageMoveTasksResultEntry(const Aws::Utils::Xml::XmlNode& xmlNode);
    AWS_SQS_API ListMessageMoveTasksResultEntry& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
